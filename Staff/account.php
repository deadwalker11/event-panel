...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Tester</b></a>
    </div>
...
if($rowcount == 0){
	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$correcti*$total.'</td><td>'.$time.'&nbsp;min</td>
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#login" >Staff Login</a></div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="#" width=100 height=100 alt="Akash N" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">AKASH N</a>
		...
		<h4 style="font-family:'typo' ">Rathinam college of arts and science</h4></div></div>
		</p>
      </div>
...
<div class="col-md-6">
<form role="form" method="post" action="adminValidation.php?q=Admin.php">
<div class="form-group">
