...
<title>Project Worlds || Knowledge tester</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="" aria-hidden="true"></span></a></li>
    ...
    <li <?php if(@$_GET['q']==5) echo'class="active"'; ?>><a href="account.php?q=5">Feedback</a></li>
...
$q=mysqli_query($con,"SELECT * FROM scores WHERE  email='$email' " )or die('Error157');
while($row=mysqli_fetch_array($q) )
{
$s=$row['score'];
...
<form role="form"  method="post" action="feed.php?q=account.php">
<div class="row">
...
<div class="modal fade title1" id="developers">
 ...
 <!--    <div class="row">
    <div class="col-md-4">
     <img src="image/CAM00121.jpg" width=100 height=100 alt="Akash image" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Akash N</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9597137088</h4>
    <h4 style="font-family:'typo' ">akashna1133@gmail.com</h4>
    <h4 style="font-family:'typo' ">Rathinam college of arts and sciecw</h4></div></div>
    </p>
      </div> -->
