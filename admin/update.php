...
header("location:adminHomepage.php?q=3");
}
}
if(isset($_SESSION['key'])){
...
header("location:adminHomepage.php?q=7");
}
}
//delete user
...
header("location:adminHomepage.php?q=5");
}
}
...
header("location:adminHomepage.php?q=4&step=2&eid=$id&n=$total");
}
}
...
header("location:adminHomepage.php?q=0");
}
}
