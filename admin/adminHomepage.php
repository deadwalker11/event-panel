...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="adminHomepage.php?q=0"><b>Dashboard</b></a>
    </div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="adminHomepage.php?q=0">Home<span class="sr-only">(current)</span></a></li>
       <!--  <li <?php/* if(@$_GET['q']==7) echo'class="active"';*/ ?>><a href="adminHomepage.php?q=7">Staff</a></li>  -->
       <li class="dropdown <?php if(@$_GET['q']==6 || @$_GET['q']==7) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="adminHomepage.php?q=6">Add Staff</a></li>
            <li><a href="adminHomepage.php?q=7">Remove Staff</a></li>
          ...
          <ul class="dropdown-menu">
            <li><a href="adminHomepage.php?q=8">Add Participate</a></li>
            <li><a href="adminHomepage.php?q=1">Remove Participate</a></li>
      
          </ul>  
<!--         <li <?php /*if(@$_GET['q']==1) echo'class="active"'*/; ?>><a href="adminHomepage.php?q=1">Participate</a></li> -->
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="adminHomepage.php?q=2">Ranking</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="adminHomepage.php?q=3">Feedback</a></li>
            
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Quiz<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="adminHomepage.php?q=4">Add Quiz</a></li>
            <li><a href="adminHomepage.php?q=5">Remove Quiz</a></li>
...
while($row = mysqli_fetch_array($result)) {
	...
	$id = $row['id'];
	 echo '<tr><td>'.$c++.'</td>';
	echo '<td><a title="Click to open feedback" href="adminHomepage.php?q=3&fid='.$id.'">'.$subject.'</a></td><td>'.$email.'</td><td>'.$date.'</td><td>'.$time.'</td><td>'.$name.'</td>
	<td><a title="Open Feedback" href="adminHomepage.php?q=3&fid='.$id.'"><b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b></a></td>';
...
<div class="card-header"><h2>Register for Staff</h2></div>
  <div class="card-body">
   <form class="form-horizontal" action="sign.php?q=adminHomepage.php" method="POST">
   <!-- Staff Name -->
...
<div class="card-header"><h2>Register for Participate</h2></div>
  <div class="card-body">
   <form class="form-horizontal" action="signp.php?q=adminHomepage.php" method="POST">
   <!-- Staff Name -->
   <div class="form-group row">
